...
class Google_AssertionCredentials {
   ...
   */
    ...
    public function generateAssertion() {
        ...
        $jwtParams = array ( 'aud' => Google_OAuth2::OAUTH2_TOKEN_URI, 'scope' => $this->scopes, 'iat' => $now, 
                'exp' => $now + self::MAX_TOKEN_LIFETIME_SECS, 'iss' => $this->serviceAccountName );
   ...
   */
    private function makeSignedJwt( $payload ) {
        ...
        $segments = array ( Google_Utils::urlSafeB64Encode( json_encode( $header ) ), 
