...
class Google_FusiontablesService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->column = new Google_ColumnServiceResource( $this, $this->serviceName, 'column', 
                json_decode( 
                        ...
                        true ) );
        $this->query = new Google_QueryServiceResource( $this, $this->serviceName, 'query', 
                json_decode( 
                        ...
                        true ) );
        $this->style = new Google_StyleServiceResource( $this, $this->serviceName, 'style', 
                json_decode( 
                        ...
                        true ) );
        $this->template = new Google_TemplateServiceResource( $this, $this->serviceName, 'template', 
                json_decode( 
                        ...
                        true ) );
        $this->table = new Google_TableServiceResource( $this, $this->serviceName, 'table', 
                json_decode( 
