...
class Google_CalendarService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->freebusy = new Google_FreebusyServiceResource( $this, $this->serviceName, 'freebusy', 
                json_decode( 
                        ...
                        true ) );
        $this->settings = new Google_SettingsServiceResource( $this, $this->serviceName, 'settings', 
                json_decode( 
                        ...
                        true ) );
        $this->calendarList = new Google_CalendarListServiceResource( $this, $this->serviceName, 'calendarList', 
                json_decode( 
                        ...
                        true ) );
        $this->calendars = new Google_CalendarsServiceResource( $this, $this->serviceName, 'calendars', 
                json_decode( 
        ...
        $this->acl = new Google_AclServiceResource( $this, $this->serviceName, 'acl', 
                json_decode( 
                        ...
                        true ) );
        $this->colors = new Google_ColorsServiceResource( $this, $this->serviceName, 'colors', 
                json_decode( 
