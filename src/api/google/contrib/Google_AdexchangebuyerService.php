...
class Google_AdexchangebuyerService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->directDeals = new Google_DirectDealsServiceResource( $this, $this->serviceName, 'directDeals', 
                json_decode( 
        ...
        $this->accounts = new Google_AccountsServiceResource( $this, $this->serviceName, 'accounts', 
                json_decode( 
                        ...
                        true ) );
        $this->creatives = new Google_CreativesServiceResource( $this, $this->serviceName, 'creatives', 
                json_decode( 
