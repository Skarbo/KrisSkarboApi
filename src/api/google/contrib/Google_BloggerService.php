    ...
    public function __construct( Google_Client $client ) {
        ...
        $this->blogs = new Google_BlogsServiceResource( $this, $this->serviceName, 'blogs', 
                json_decode( 
                        ...
                        true ) );
        $this->posts = new Google_PostsServiceResource( $this, $this->serviceName, 'posts', 
                json_decode( 
                        ...
                        true ) );
        $this->pages = new Google_PagesServiceResource( $this, $this->serviceName, 'pages', 
                json_decode( 
        ...
        $this->comments = new Google_CommentsServiceResource( $this, $this->serviceName, 'comments', 
                json_decode( 
                        ...
                        true ) );
        $this->users = new Google_UsersServiceResource( $this, $this->serviceName, 'users', 
                json_decode( 
