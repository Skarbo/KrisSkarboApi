...
class Google_ResponsesServiceResource extends Google_ServiceResource {
    ...
    public function insert( $seriesId, $topicId, $parentSubmissionId, Google_Submission $postBody, $optParams = array() ) {
        $params = array ( 'seriesId' => $seriesId, 'topicId' => $topicId, 'parentSubmissionId' => $parentSubmissionId, 
                'postBody' => $postBody );
        $params = array_merge( $params, $optParams );
        $data = $this->__call( 'insert', array ( $params ) );
        if ( $this->useObjects() ) {
...
class Google_ModeratorService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->votes = new Google_VotesServiceResource( $this, $this->serviceName, 'votes', 
                json_decode( 
                        ...
                        true ) );
        $this->responses = new Google_ResponsesServiceResource( $this, $this->serviceName, 'responses', 
                json_decode( 
                        ...
                        true ) );
        $this->tags = new Google_TagsServiceResource( $this, $this->serviceName, 'tags', 
                json_decode( 
                        ...
                        true ) );
        $this->series = new Google_SeriesServiceResource( $this, $this->serviceName, 'series', 
                json_decode( 
                        ...
                        true ) );
        $this->series_submissions = new Google_SeriesSubmissionsServiceResource( $this, $this->serviceName, 
                'submissions', 
                json_decode( 
                        ...
                        true ) );
        $this->series_responses = new Google_SeriesResponsesServiceResource( $this, $this->serviceName, 'responses', 
                json_decode( 
                        ...
                        true ) );
        $this->topics = new Google_TopicsServiceResource( $this, $this->serviceName, 'topics', 
                json_decode( 
                        ...
                        true ) );
        $this->topics_submissions = new Google_TopicsSubmissionsServiceResource( $this, $this->serviceName, 
                'submissions', 
                json_decode( 
                        ...
                        true ) );
        $this->global_series = new Google_ModeratorGlobalSeriesServiceResource( $this, $this->serviceName, 'series', 
                json_decode( 
                        ...
                        true ) );
        $this->profiles = new Google_ProfilesServiceResource( $this, $this->serviceName, 'profiles', 
                json_decode( 
                        ...
                        true ) );
        $this->featured_series = new Google_FeaturedSeriesServiceResource( $this, $this->serviceName, 'series', 
                json_decode( 
                        ...
                        true ) );
        $this->myrecent_series = new Google_MyrecentSeriesServiceResource( $this, $this->serviceName, 'series', 
                json_decode( 
                        ...
                        true ) );
        $this->my_series = new Google_MySeriesServiceResource( $this, $this->serviceName, 'series', 
                json_decode( 
                        ...
                        true ) );
        $this->submissions = new Google_SubmissionsServiceResource( $this, $this->serviceName, 'submissions', 
                json_decode( 
