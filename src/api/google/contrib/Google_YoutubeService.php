...
class Google_YoutubeService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->channels = new Google_ChannelsServiceResource( $this, $this->serviceName, 'channels', 
                json_decode( 
                        ...
                        true ) );
        $this->search = new Google_SearchServiceResource( $this, $this->serviceName, 'search', 
                json_decode( 
                        ...
                        true ) );
        $this->playlistitems = new Google_PlaylistitemsServiceResource( $this, $this->serviceName, 'playlistitems', 
                json_decode( 
                        ...
                        true ) );
        $this->playlists = new Google_PlaylistsServiceResource( $this, $this->serviceName, 'playlists', 
                json_decode( 
                        ...
                        true ) );
        $this->videos = new Google_VideosServiceResource( $this, $this->serviceName, 'videos', 
                json_decode( 
