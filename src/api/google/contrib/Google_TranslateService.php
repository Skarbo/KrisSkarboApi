...
class Google_TranslateService extends Google_Service {
   ...
   */
    public function __construct( Google_Client $client ) {
        ...
        $this->languages = new Google_LanguagesServiceResource( $this, $this->serviceName, 'languages', 
                json_decode( 
                        ...
                        true ) );
        $this->detections = new Google_DetectionsServiceResource( $this, $this->serviceName, 'detections', 
                json_decode( 
                        ...
                        true ) );
        $this->translations = new Google_TranslationsServiceResource( $this, $this->serviceName, 'translations', 
                json_decode( 
